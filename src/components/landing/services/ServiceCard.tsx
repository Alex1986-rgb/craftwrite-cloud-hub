...
import { ArrowRight, Zap, CheckCircle, Star, FileText } from "lucide-react";
import type { Service } from "@/data/types/service";
import { ENHANCED_TEXT_EXAMPLES } from "@/data/services/enhancedTextExamples";
import { useState } from "react";
import TextExampleModal from "@/components/examples/TextExampleModal";
...
const ServiceCard = ({ service, index }: ServiceCardProps) => {
  ...
  const hasExample = ENHANCED_TEXT_EXAMPLES[service.slug]?.length > 0;
  const example = hasExample ? ENHANCED_TEXT_EXAMPLES[service.slug][0] : null;
          ...
          <div className="flex flex-col gap-2">
            ...
            {hasExample && (
              <Button
                ...
                className="w-full rounded-xl border border-emerald-200 hover:bg-emerald-50 text-emerald-700 font-medium"
              >
