interface TestPageBackgroundProps {
  children: React.ReactNode;
  className?: string;
}

export default function TestPageBackground({ children, className = "" }: TestPageBackgroundProps) {
  return (
    <div className={`min-h-screen bg-gradient-to-br from-background via-muted/20 to-accent/10 relative overflow-hidden ${className}`}>
