...
import { CheckCircle2, AlertCircle, TrendingUp, Lightbulb, ChevronDown } from 'lucide-react';
      ...
      <Accordion type="single" collapsible defaultValue={defaultOpen ? "content" : undefined}>
        <AccordionItem value="content" className="border-none">
          <AccordionTrigger className="hover:no-underline p-0">
            <CardHeader className="w-full bg-gradient-to-r from-blue-50 to-purple-50 border-b">
